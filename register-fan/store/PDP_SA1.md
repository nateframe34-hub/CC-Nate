...
**Congruence rule:** the click came from a world of fans, thermometers and duct runs. The page opens in that same world. A page that switches vocabulary makes them climb a rung twice.
...
> ### A fan cools you. It doesn't cool the room.
>
...
> Your AC cools air in one place and pushes it through ducts to every room. The rooms nearest the unit get it first, at full strength. Every turn, every branch, every foot of duct takes a little off.
>
> **The room at the end of the run gets whatever's left.**
>
...
> ### Go and put your hand on that vent.
>
...
> ### Measure the hole, not the cover.
>
...
| | |
|---|---|
| **Another fan** | Cools whoever's in front of it. The room stays where it is |
| **Turning the AC down** | Over-cools every room that was already fine, all day, to fix one |
| **A contractor** | Rebalancing a duct run is commonly quoted in the thousands. It may well be the right permanent fix. It isn't happening this week |
| **Nothing** | What most people do. For years |

*No competitor named. No cheaper version referenced. The comparisons on this page are the ones they arrived with.*

## 11. What you get for $89.99
...
> **60 days. If that room doesn't change, send it back.**
>
...
- **Accent terracotta `#B4553A`** on every CTA, tick and section band · base `#FAF7F2` · text `#1C1A17`
