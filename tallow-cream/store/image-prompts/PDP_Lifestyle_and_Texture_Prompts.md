...
An ultra-realistic iPhone photo, close-cropped on a pair of hands rubbing whipped balm into knuckles and the backs of the hands, some product still visible on the fingertips, mid-application. The open jar of Whipped Tallow & Honey Balm sits naturally in the foreground on a wooden potting bench or the edge of a raised garden bed, in soft focus, clearly recognizable but not the main subject. Garden tools nearby in frame, a trowel, worn gloves, a coiled hose, late afternoon natural light, unstyled suburban backyard. No faces, no people beyond the hands, no text, no logos beyond what's naturally on the jar's own label. 4:5 aspect ratio.
