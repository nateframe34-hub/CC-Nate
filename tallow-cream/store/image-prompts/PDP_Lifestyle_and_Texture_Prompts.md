...
**2026-07-14 revision, Version A:** founder pushback, the original version had zero trace of the product, reasonable to question on a page whose entire job is selling one object. Rewrote Version A as an application shot (hands rubbing the balm in, jar visible in soft focus nearby), keeps the ad-congruence context (garden tools, backyard setting) while also anchoring the product itself. B and C below are still in the original context-only style, worth applying the same fix to those if this version performs, ask before regenerating since it wasn't explicitly requested yet.

### Version A: Gardeners (matches B26C1)
An ultra-realistic iPhone photo of a WOMAN'S hands, age 45-55, natural unmanicured nails, no rings, one hand smoothing whipped balm into the back of the other hand and wrist in a natural, single-direction rubbing motion (not two hands overlapping or clasped), a small amount of balm visible catching the light on the skin. The open jar of Whipped Tallow & Honey Balm sits in soft focus on a wooden potting bench behind the hands, clearly recognizable but secondary to the hands. Garden tools resting nearby, a trowel, worn gloves, a coiled hose, late afternoon natural light, unstyled suburban backyard, ordinary fence visible in the blurred background. Natural, slightly imperfect phone-camera framing, not a staged or symmetrical pose. No face, no other people, no text, no logos beyond what's naturally on the jar's own label. Portrait 4:5 aspect ratio, hands and jar both fully in frame with no awkward cropping at the edges.
