...
```
Professional studio product photography, wide shot, zoomed out. A small 4oz amber glass jar with a black ribbed screw-top lid and kraft paper label sits on a clean white matte tabletop surface in the lower-center of the frame. The jar is SMALL in the frame, taking up only about 30% of the image height. There is a large amount of empty space above the jar and to both sides. The background is a smooth soft teal gradient wall behind the table surface. The jar casts a subtle soft shadow on the white surface. Professional controlled studio lighting, soft and even, with a slight rim light separating the jar from the teal background. The camera is positioned at a slight downward angle, about 15-20 degrees above eye level, looking down at the jar on the table — similar to how you would photograph a product sitting on a countertop from a standing position. The entire jar is visible including the base. Clean, minimal, professional e-commerce photography. 8K resolution, sharp focus on the jar and label. Lots of negative space for text placement above the product.
```
