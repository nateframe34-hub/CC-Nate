...
**SUPERSEDED 2026-07-07, founder decision: the tin is OUT entirely, replaced by a $10 next-jar credit.** Founder's reasoning, which is correct and kills the tin on marketing-incongruence grounds the earlier revision missed: the core mechanism claim is "apply at 7am, still there at 2pm," and the best converting beat is her STOPPING carrying lotion around. Gifting a carry-tin implies reapplication is needed, contradicting both. Additionally, advertorial/native-warmed traffic arrives at the PDP already believing (the story does the uncertainty-gap work before the click reaches the page), so the first-purchase offer's job there is tipping a warm decision with added value, not crossing the gap, which is exactly where a "$10 toward your next jar" credit works: near-zero cost, incentivizes the reorder, and quietly plants the assumption there WILL be a next jar. Presentation rule: a named line in the offer stack ("comes with a $10 credit toward your next jar"), not the offer headline, since its perceived value is still future-contingent. Mechanically: simplest implementation is a unique $10 single-use discount code delivered post-purchase (email + box insert), not a literal Shopify gift-card product, same effect, zero apps. The full stack: $49.99 + 20% sticker + free ship + 60-day guarantee + $10 next-jar credit (first purchase) -> post-purchase one-click second jar $34.99 -> week-7 reorder email reminding the $10 credit exists.

**(Historical) CORRECTED 2026-07-05, supplier constraint:** a pre-filled mini is not possible, the supplier can only provide the current jar and size, plus EMPTY travel tins. Revised recommendation: **free empty purse tin, framed as "your purse tin, fill it from your jar."** This survives the constraint better than it first sounds: (a) the habit-cessation story still works, she scoops from the big jar into the tin and carries it, which is exactly what real tallow users already do since the balm is temperature-stable; (b) the framing must be explicitly "fill it from your jar", never implying it arrives filled, both for honesty and because an unexplained empty tin reads as cheap, while a purposeful refill-tin reads as thoughtful; (c) COGS drops to roughly $1-2; (d) perceived value is lower than a filled mini, so the offer line has to do more work, lean on the story ("the packets she used to buy in three places, replaced by one tin she refills for free"). If the empty tin underperforms as a gift, the fallback candidates are cheap non-supplier items (muslin face cloths, small linen pouch), but the tin keeps the story congruence none of those have.
