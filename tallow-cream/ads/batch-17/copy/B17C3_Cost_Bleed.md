...
**Mechanism:** Cost-Bleed. Sunk-cost urgency made visible. The pressure is the money already wasted on what did not work, surfaced as the narrator's own quiet add-up. The reader catches the urgency by recognizing her own receipts, never through the ad making a price argument or pointing at her wallet.
...
- **Variable isolated:** Urgency anchor only. Anchor type: sunk-cost / money already wasted.
...
- **Word count:** ~1,600 (anchor adds ~100 net words).
