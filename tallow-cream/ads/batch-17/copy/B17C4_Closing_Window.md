...
## The Urgency Anchor (the variable being tested)
...
- ✅ Frame is "still recoverable, takes more attention now," NOT "getting worse." The skin "still answers" is the live operative phrase, the slowness is downstream.
- ✅ Zero "your skin," zero second-person hurry, zero "before it's too late," zero "act now," zero deadline
- ✅ Garden metaphor pulls the urgency OUT of the medical/health-claim register and into the domestic/gardener register, which is Winnie's natural voice
- ✅ Zero banned phrases (menopause, hormones, anti-aging, wrinkles)
- ✅ The reader's takeaway is recoverability and a soft sense of "I should not wait forever," but the ad never SAYS that, she infers it. The same way she infers urgency from "fourteen things on the counter" in the original.
- ✅ The close ("link is below if you want it") stays untouched; no urgency CTA

**Pre-launch read-aloud check (mandatory before this cell ships):**
- Read the Winnie/Elaine garden beat aloud. If it sounds like the brand telling a woman her skin is getting worse and she needs to hurry, the cell fails. Rewrite or drop.
- Read it again replacing "skin" with "garden" throughout the beat. The metaphor should still land. If it doesn't, the metaphor is doing too much work and the cell is fishy.

**What this cell answers if it wins vs C1:** recoverability urgency delivered in the elder's voice is the right kind to add. Mechanism: the buyer hears a calm, non-pressuring observation about a still-open window from a 76-year-old gardener and that lands harder than a deadline or a sales pitch ever could. If the cell loses or trips compliance, recoverability urgency is closed for this brand and we do not try it again.

---

## Image Prompt (same image across all B17 cells)

Same as B17C1, the near-empty counter with one amber jar. Same prompt, same aspect ratio. Image is held constant across cells per the test design.

---

## Test Setup Notes

- **Variable isolated:** Urgency anchor only. Anchor type: recoverability / closing-window (high-risk).
- **Ad-set config:** ABO, $12.50/day, fresh BM after warmup gates, single broad audience (35-65, female, US/EN), Purchase optimization, Advantage+ Placements, same image and headline/description as C1.
- **Word count:** ~1,610 (anchor adds ~110 net words inside the discovery scene).
- **Density:** 10/10 preserved + Urgency Anchor as element 11 (v2 skeleton).
- **Compliance:** clean per audit above, with the pre-launch read-aloud check as a hard gate.

**Status: ready to ship after the founder's pre-launch read-aloud confirmation that the garden beat lands as recoverability, not deterioration.**
