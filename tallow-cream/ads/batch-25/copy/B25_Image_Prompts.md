...
**Full image prompt (revised):**
```
A tight, high-contrast, moody product-ad photograph, full bleed edge to edge, 4:5 aspect ratio, 1080x1350, shot like a real commercial/editorial campaign, not a warm lifestyle stock photo. Main image: two hands (a giving/receiving gesture) holding an open amber glass jar of whipped balm between them at a slight angle so its simple kraft-paper label is clearly legible and dominant in frame, filling most of the composition. Background is plain and darkened with generous negative space, no cluttered counter, no other products visible at all. Cooler, higher-contrast lighting, slightly moody and directional, deep shadows, crisp highlight on the glass and label. In the upper right corner, a small circular inset photo (thin white ring border, subtle drop shadow) showing a genuinely strained, sharply lit close-up: a different woman holding a generic bottle at arm's length, mouth open mid-word, visibly struggling and frustrated trying to pronounce something on the label, real tension in her expression, lit with the same cooler contrast as the main image. Across the bottom third, a solid near-black rectangular block (not a gradient) for maximum text contrast, with large bold white sans-serif all-caps text: "MOST MOISTURIZERS NEED A CHEMISTRY DEGREE TO READ THE BACK." with the phrase "CHEMISTRY DEGREE" in a warm accent amber/gold color, rest in white. Below that, smaller white text: "THIS ONE DOESN'T..." A thin horizontal divider line and small logomark could sit above the headline block, similar to a real produced commercial ad. No badge, no news graphic elements, no fake outlet branding.
```
