...
**Why this exists:** The old sub-avatars ("Invisible Woman," "Homesteader Mom," "Working Hands Man") were demographic/identity profiles, which drifted from Origins teaching. Real Origins sub-avatars are DESIRE-first, built from desire + experience + emotion, and can span gender and age. This doc also fixes two things the account has never explicitly operated with: market sophistication level and awareness levels.
...
Skin makes its own oil (sebum), and after roughly age 40 it makes much less. Most moisturizers are water-first formulas: water evaporates within about an hour, so the product is gone by midday and skin feels tight again. Tallow is a fat whose structure is close to the fat skin makes on its own, so skin absorbs it in instead of letting it sit on top, and it doesn't evaporate.
**6th-grade version:** Your skin makes its own oil. As you get older it makes less. Creams made of water dry up and disappear in an hour. This balm is made of fat that's almost the same as your skin's own oil, so your skin drinks it in and it stays all day.

## Step 3-5: Features -> Benefits -> Desires

| Feature | Benefit (what it does for them) | Deeper desire it serves |
|---|---|---|
...
## Step 6: New Mechanisms / USPs (expanded in Part 5)
...
- **A jar lasts ~10 weeks.** Real buyers say "a little goes miles." Never led with cost-per-day.
- **If it worked TOO well, the complaint would be:** "I stopped needing all my other products and my routine feels weirdly empty," and "I have to explain to people why I only use one thing." (Both are ad concepts hiding in plain sight, and the second one already converted as B9C3.)
- **What a friend would say:** "It's beef fat and honey, I know how it sounds, but my skin stopped feeling tight for the first time in years."

---

# PART 2: CORE DESIRE + CORE AVATARS

Per Origins: desire first, avatar second. You cannot create desire, only channel it. The product's proven performances channel these mass instincts, ranked by the account's own conversion evidence:

**CORE AVATAR (primary, stays):**
- **Desire:** Wants to look like themselves again and be SEEN again (skin that doesn't look "tired," a partner/friends who notice). Mass instincts: **Relationships + Status**, delivered through a **Health/Comfort** product. This elevation (comfort product sold on being-noticed) is exactly why the husband-notice close and peer-envy hook out-converted everything else. The single most validated customer phrase: "My skin doesn't look tired anymore."

**SECONDARY CORE AVATARS (valid, lower priority):**
- **Desire: skin that finally feels comfortable** (not tight by noon, not managed all day). Mass instinct: Comfort. This is the mechanism-buyer's desire, proven as the water-vs-fat beat converting standalone (B19C2).
- **Desire: to trust what they put on their skin** (read the label, understand it). Mass instinct: Control/Safety. Validated in review research ("I cannot tell you the relief"), signaled by B20C3, never fully tested as a lead desire.

**Forces of change working for us (Mass Education):** consumers have learned "water/glycerin first ingredient = filler," ingredient literacy is mainstream now, and "tallow" itself is having a style-trend moment (ancestral/simple living). Mass Education + Mass Instinct combinations produce the biggest breakthroughs, and our proven mechanism reveal (water evaporates, fat absorbs) is exactly that combination.

---

# PART 3: MARKET SOPHISTICATION (the missing layer)

**The moisturizer market overall: STAGE 5 (complete sophistication).** The 45+ buyer has heard every claim that exists: hydrating, anti-aging, dermatologist-tested, clinically proven, natural, clean. She actively looks for reasons NOT to believe. Direct benefit claims ("deeply hydrates!") are dead on arrival. This is why generic-benefit ads flop regardless of execution quality.
...
3. **New Identity (tertiary, emerging):** "the woman with one jar," anti-shelf, anti-complexity, quiet confidence. B24 Cell C's industry-critique framing is the first deliberate test of this response. Don't lead the whole brand with it yet; it's the least proven of the three here.

**Operating rule going forward:** every ad must clear the Stage-5 filter. Before launching, ask: "Has she heard this exact claim before?" If yes, the ad needs a mechanism, information, or identity layer to carry it. A claim alone is a flop at Stage 5 no matter how good the creative is.

---

# PART 4: AWARENESS LEVELS (the other missing layer)

Schwartz's five levels, mapped to this market, with where our ads have actually been operating:

| Level | Who she is | What the ad must do | Our evidence |
|---|---|---|---|
...
# PART 5: UNIQUE MECHANISMS (per the New Mechanism prompt doc)

Ranked by strength. Each = "the reason why it works when everything else didn't," each gives NEW HOPE.
...
4. **~~Whipped Absorption~~ → Fast Absorption (RETIRED AS WRITTEN, 2026-07-28).** The reformulated product is denser and not whipped, so every "whipped" hook is dead. The underlying job — killing the grease/heaviness objection — is still the #1 category objection. **The replacement is now confirmed: apply to damp skin.** Found three times independently across two research rounds (*"Put your moisturizer on while your skin is still a bit damp, not after it has dried off completely. It absorbs so much better that way and actually does something"* / *"THE KEY FOR ME IS MAKING SURE YOUR FACE IS STILL WET"*). Costs nothing, is verbatim-sourced, and is usage education rather than a claim — a New Information play. **Add to the PDP and post-purchase email regardless of ad use**, since it may also explain some "it didn't work for me" reviews.
...
- ✅ **EVIDENCE GAP RESOLVED 2026-07-29 — and the answer was a null result.** Problem-side research found **zero clock-time language.** Not one "by 2pm," "by noon," or "midday" anywhere in the sample. Confirmed: **every time-based SA4 hook we have written is our own invention.** B19C2 converted on it and we have been citing ourselves ever since. The sensation is real; the clock is not their frame.
- 🔑 **Their actual frame is PRODUCT FAILURE, not time:** *"why does moisturizers gives me nothing"* / *"why our skin become tight even after putting moisturizer?"* / *"they sit there on top and feel like something is on your skin but underneath it still feels uncomfortable and pulled."* Physical description is more vivid than ours: *"it almost feels like it's being shrunk on my face... Like plastic over a flame."*
- 🔑 **TARGETING REFINEMENT (2026-07-29):** the default recommendation in these threads is CeraVe in the tub at ~$12, and it *works for some people*. We are a 4x-price answer to a $12 question. **The price is only defensible to someone already on their sixth moisturizer, not their first** — and those people are all over the same threads (*"Tried many of them. Avene, la Roche, Bioderma, Some Korean…"*). Target the sixth, never the first. This is also SA2 appearing inside SA4's research; the two overlap more than the roster implies.
- Full findings: `avatars/Problem_Side_Research_Findings_2026-07-29.md`

**Angle 1: Still tight even after moisturizing** *(REBUILT 2026-07-29 from verbatim; supersedes the time-based framing as the lead)*
Reason to buy: the moisturizer isn't absorbing, it's sitting on top — because it's mostly water. Fat absorbs instead, so the tightness doesn't come back.
- "Still tight. Even after moisturizer."
- "Your moisturizer isn't absorbing. It's sitting there."
- "Like plastic over a flame." *(verbatim, unusually visual)*
- *Structural note: this hook is stronger than the clock version because it states the problem AND sets up the mechanism reveal in one line. "Why isn't it working?" → "because it's mostly water." The time-based hook never had that built in.*

**Angle 1b: Still there at 2pm** *(TESTED, CONVERTING, B19C2 — KEEP, but as our framing, not customer language)*
...
- **Evidence:** 6 independent sources, substantially reinforced 2026-07-29.

### 2026-07-29 problem-side findings (`avatars/Problem_Side_Research_Findings_2026-07-29.md`)

- 🔑 **THE BEHAVIOR HAS A COMMUNITY NAME: "sandwiching."** *"i'm currently sandwiching!"* Moisturizer → active → moisturizer. Along with "slugging," this is SA9's own vocabulary. **Use their word, not ours.**
- 🔑 **Ownable specificity found:** Vaseline applied to **nose creases, lip corners, and eye corners** *before* the active — a dermatologist-taught technique described as *"a lightbulb moment."* Nobody's copy names those three zones.
- 🔑 **The fear is more precise than previously written.** Not general discomfort — **"I will have to quit the thing that's finally working."** *"I can't even bear to look at myself in the mirror and most days, i regret starting tret"* / *"ready to throw in the towel"* / *"always quit because the peeling was so bad"* (51, ten years on and off). Angle 1 should carry this directly.
- 🔑 **SA9 IS NOT A YOUNG-PERSON AVATAR.** A large share of tret users are on it for **anti-aging, not acne** (*"in my case I'm using for anti-aging"*, plus users aged 45 and 51 in-sample). This pulls SA9 much closer to our existing 45+ buyer than the original read assumed, and materially raises its value.
- 🔑 **Trade-pride register confirmed, same as SA6 and SA8:** *"it'll be worth it in the end,"* *"trust the process."* They are not looking to be rescued from the treatment — they're looking to survive it. **Any copy positioning us as an alternative to the active will fail.** Angles 1 and 2 already get this right; now externally confirmed.
- 🔗 **Cross-links to SA5:** routine minimalism is the consensus advice in this community (*"Keeping my routine as simple as possible... helped my treatment success tremendously,"* *"pull your routine right back, no extra actives"*). Our 4-ingredient story lands here for an unused reason: **not "clean," but "won't interfere."**
- ⚠️ **Competitive set confirmed cheap:** Vaseline, Aquaphor, CeraVe in the tub. Same ~$12-15 price frame as SA4. Same implication — target someone who has already failed with those, not someone who hasn't tried them.
- **Status:** UNTESTED.
...
# PART 8: HOW TO USE THIS DOCUMENT (operating rules)

1. **Every new ad cell file must state:** target sub-avatar (from Part 6), angle (from Part 7 or a new one added there), awareness level (Part 4), and which sophistication response it uses (mechanism / information / identity). No more implicit targeting.
