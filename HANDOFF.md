...
| Batch 12 testing | DEPRIORITIZED for now | None | Not in the Monday launch. Reasoning to confirm: B12 ads are locked-formula rebuilds of the converter skeleton; B7C1 already represents that formula. B13 (new sub-avatar) is the more interesting test variable. B12 can layer in after B13 has data. |
