...
| Engagement campaign | LIVE — Day 1 dropped from $5 CPM to >$3 CPM, $10 spent so far | None | Continue at $5-7/day. $50 target is a heuristic, not a hard rule (see Open Questions). DO NOT raise budget — fresh Portfolios that surge spending get flagged. |
